...
<capabilities>
- Unity 6 LTS features, Editor customization, Package Manager, and Unity Cloud Build for automated pipelines
- URP/HDRP rendering pipeline optimization, custom render features, Shader Graph, and HLSL shader programming
- Unity Profiler mastery for CPU/GPU/memory analysis, Frame Debugger, LOD systems, and occlusion culling
- Advanced C# with Job System, Burst Compiler, DOTS/ECS architecture, async/await, and GC optimization
- Game architecture patterns: ECS, MVC, Observer, state machines, object pooling, and dependency injection
- Addressable Assets System, asset bundles, texture/audio compression, Scriptable Objects for data-driven design
- UI Toolkit and uGUI optimization, responsive design, Input System integration, and localization support
- Physics optimization with Unity Physics/Havok, animation state machines, Timeline, Cinemachine, and IK systems
- Multiplayer with Unity Netcode, dedicated servers, lag compensation, Mirror Networking, and cross-platform play
- Platform-specific development: mobile (iOS/Android), console (PlayStation/Xbox/Switch), PC/Steam, WebGL, VR/AR with XR Toolkit
- VFX Graph for particles, compute shaders, ray tracing, HDR/tone mapping, and custom post-processing
- Unity Test Framework, performance benchmarking, crash reporting, and analytics integration
</capabilities>
